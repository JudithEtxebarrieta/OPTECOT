'''
This script is an adaptation of script experimentScripts_CartPole/UnderstandingAccuracy_figures.py. 
...
def from_data_to_figures_paper(df):
    ...
    ax=plt.subplot(221)
    ax.set_title(r'\textbf{CartPole}',fontsize=16)
    ...
    ax.set_xticklabels(convert_textbf(range(0,80,20)),rotation=0)
    ...
    ax.set_yticklabels(convert_textbf(list_acc_float),rotation=0,fontsize=16,weight='bold')

    # Save graph.
    plt.savefig('figures_paper/figures/UnderstandingAccuracy/UnderstandingAccuracy_CartPole.png')
    plt.savefig('figures_paper/figures/UnderstandingAccuracy/UnderstandingAccuracy_CartPole.pdf')
    plt.show()
    plt.close()

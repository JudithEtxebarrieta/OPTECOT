'''
This script is an adaptation of script experimentScripts_SymbolicRegressor/UnderstandingAccuracy_figures.py. 
...
def from_data_to_figures_paper(df):
    ...
    for accuracy in list_acc:
        mean,q05,q95=bootstrap_mean_and_confidence_interval(list(df[df['accuracy']==accuracy]['n_eval']))
    ...
    ax=plt.subplot(221)
    ax.set_title(r'\textbf{SR}',fontsize=16)
    ...
    ax.set_xticklabels(convert_textbf(range(0,60,10)),rotation=0)
    ...
    # Save graph.
    plt.savefig('figures_paper/figures/UnderstandingAccuracy/UnderstandingAccuracy_SymbolicRegressor.png')
    plt.savefig('figures_paper/figures/UnderstandingAccuracy/UnderstandingAccuracy_SymbolicRegressor.pdf')
    plt.show()
    plt.close()
...
# MAIN PROGRAM
#==================================================================================================
df=pd.read_csv('results/data/SymbolicRegressor/UnderstandingAccuracy/df_UnderstandingAccuracy.csv',index_col=0)

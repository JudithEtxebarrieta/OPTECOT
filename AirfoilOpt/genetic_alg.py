...
def evaluate_population(population, syn_func, n_iter):
    performance = []
    for individual in population:
        airfoil = syn_func(individual)
        performance.append(evaluate(airfoil, n_iter=n_iter))
    return performance

def select_best(population, n_best, syn_func, n_iter):
    performance = evaluate_population(population, syn_func, n_iter)
...
def select(population, n_best, n_random, syn_func, n_iter):
    best, best_perf = select_best(population, n_best, syn_func, n_iter)

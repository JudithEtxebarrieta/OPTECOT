...
def from_argsort_to_ranking(list):
    '''Obtain ranking from a list obtained after applying "np.argsort" on an original list.'''
...
def from_data_to_figures(df):
    ...
    #----------------------------------------------------------------------------------------------
    # GRAPH 1: Execution time per accuracy.
    #----------------------------------------------------------------------------------------------
    ...
    #----------------------------------------------------------------------------------------------
    # GRAPH 2: Number of extra evaluations.
    #----------------------------------------------------------------------------------------------
    ...
    for i in range(0,len(list_total_times)):
        ...
        # Number of extra evaluations that could be done to use up the default time needed.
    ...
    color[:1, :]=np.array([248/256, 67/256, 24/256, 1])# Red (rgb color)
    ...
    # Save graph.
    plt.savefig('results/figures/MuJoCo/UnderstandingAccuracy.png')
    plt.show()
    plt.close()

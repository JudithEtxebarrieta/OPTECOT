...
#--------------------------------------------------------------------------------------------------
# Para la gráfica de scores durante el entrenamiento.
#--------------------------------------------------------------------------------------------------
...
#--------------------------------------------------------------------------------------------------
# Para la gráfica de las ventajas de usar un accuracy menor.
#--------------------------------------------------------------------------------------------------
...
def ranking_spearman_correlation(df):
    ...
    for N in list_N:
        ...
        for seed in list_seeds:
            # Lista de scores máximo accuracy y su ranking.
            ...
            # Añadir a lista correlación entre rankings.
...
#--------------------------------------------------------------------------------------------------
# GRÁFICA 1: scores durante el entrenamiento para diferentes accuracys.
#--------------------------------------------------------------------------------------------------
...
# Fijar valor de parámetro blade-number.
blade_number=3
...
#--------------------------------------------------------------------------------------------------
# GRÁFICA 2: comparación de rankings para los diseños de turbinas evaluados por todos los accuracys.
#--------------------------------------------------------------------------------------------------
...
#--------------------------------------------------------------------------------------------------
# GRÁFiCA 3: ventajas de considerar un accuracy menor.
#--------------------------------------------------------------------------------------------------
#__________________________________________________________________________________________________
# SUBGRÁFICA 1: perdida de calidad.
print(1)
...
#__________________________________________________________________________________________________
# SUBGRÁFICA 3: evaluaciones extra.
print(3)
# Calcular arrays que se usarán para dibujar la gráfica.
...
#__________________________________________________________________________________________________
# SUBGRÁFICA 4: scores totales en el límite de tiempo definido.
print(4)
# Calcular arrays que se usarán para dibujar la gráfica.
